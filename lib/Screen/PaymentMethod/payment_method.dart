...
class _PaymentMethodScreenState extends State<PaymentMethodScreen> {
  ...
  List<Map<String, dynamic>> listService = [
    {
      ...
      "name": 'VISA',
      "numberCard": "**** **** **** 1234",
      "image": "assets/image/image_visa.png",
    },
    {
      "id": '1',
      "name": 'Paypal',
      "numberCard": "1234 5678 9123 4569",
      "image": "assets/image/image_paypal.png"
    },
    {
      "id": '2',
      "name": 'Master Card',
      "numberCard": "1234 5678 9123 4569",
      "image": "assets/image/image_mastercard.png"
    },
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          localize(context, 'paymentMethods'),
