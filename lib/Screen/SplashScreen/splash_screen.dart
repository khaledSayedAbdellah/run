...
class _SplashScreenState extends State<SplashScreen>
  ...
  void initState() {
    ...
    new Timer(
      ...
      () async {
        if (await PrefManager.currentUser.id.isNotEmpty) {
          Navigator.of(context).pushNamedAndRemoveUntil(
              AppRoute.homeScreen, (Route<dynamic> route) => false);
        } else {
          print(await PrefUtils.getBool(PrefKeys.FIRST_TIME).toString());
          if (await PrefUtils.getBool(PrefKeys.FIRST_TIME) ||
              await PrefUtils.getBool(PrefKeys.FIRST_TIME) != null) {
            Navigator.of(context).pushNamedAndRemoveUntil(
