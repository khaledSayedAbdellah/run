    ...
    return showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            title: Text(localize(_scaffoldKey.currentContext, 'confirmDelete')),
            content: Text(localize(_scaffoldKey.currentContext, 'sureDelete')),
            actions: <Widget>[
              FlatButton(
                  onPressed: () {
                  ...
                  child: new Text(
                    localize(_scaffoldKey.currentContext, 'cancel'),
                    style: textGrey,
                  )),
              FlatButton(
                onPressed: () {
                ...
                child: Text(
                  localize(_scaffoldKey.currentContext, 'ok'),
                ),
              ),
            ],
          );
                      ...
                      child: Slidable(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                              border: Border(
                                  bottom:
                                      BorderSide(color: greyColor2, width: 1))),
