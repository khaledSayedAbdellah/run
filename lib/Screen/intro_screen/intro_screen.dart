...
//    permissions = await PermissionHandler().requestPermissions([PermissionGroup.location]);
  ...
  initIntros() {
    listItem = [
      {
        "id": '0',
        "title": localize(context, 'introTitle1'),
        "description": localize(context, 'introDesc1'),
        "image": "assets/image/image_taxi_1.png"
      },
      {
        "id": '1',
        "title": localize(context, 'introTitle2'),
        "description": localize(context, 'introDesc2'),
        "image": "assets/image/image_taxi_2.png"
      },
      {
        "id": '2',
        "title": localize(context, 'introTitle3'),
        "description": localize(context, 'introDesc3'),
                ...
                ? Container(
                    ...
                    child: ButtonTheme(
                      ...
                      child: RaisedButton(
                        ...
                        child: Text(
                          localize(context, 'continueToApp'),
                          style: TextStyle(color: blackColor, fontSize: 16),
                        ),
                        color: primaryColor,
                        onPressed: () {
                          requestPermission()?.then((_) async {
                            await PrefUtils.setBool(PrefKeys.FIRST_TIME, false);
